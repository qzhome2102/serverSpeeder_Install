...
URLKernel='https://raw.githubusercontent.com/qzhome2102/serverSpeeder_kernel/master/serverSpeeder.txt'
...
{
[ ! -f /tmp/appex.zip ] && wget --no-check-certificate -q -O "/tmp/appex.zip" "https://raw.githubusercontent.com/ggsjj/serverSpeeder_Install/master/appex.zip"
